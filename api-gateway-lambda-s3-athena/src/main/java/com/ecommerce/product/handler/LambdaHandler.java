    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent apiGatewayProxyRequestEvent, Context context) {
        ...
        if (apiGatewayProxyRequestEvent != null) {
            if (apiGatewayProxyRequestEvent.getBody() != null) {
                try {
                    return productService.saveProductLambda(apiGatewayProxyRequestEvent, context);
                } catch (JsonProcessingException e) {
                    throw new RuntimeException(e);
                }
            } else {
                try {
                    return productService.readAllProductLambda(apiGatewayProxyRequestEvent, context);
                } catch (JsonProcessingException e) {
                    throw new RuntimeException(e);
                }
            }
